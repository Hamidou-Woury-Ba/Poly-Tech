...
GRANT ALL PRIVILEGES ON mglsi_news.* TO mglsi_user;

FLUSH ALL PRIVILEGES;

SELECT Article.titre, Categorie.libelle FROM Article INNER JOIN Categorie ON Article.id = Categorie.id WHERE Article.id = 1;
